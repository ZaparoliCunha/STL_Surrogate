# Gaussian Process Regression based surrogate of the Sound Transmission Loss analyses
...
kernel  = C(1.0)*Matern(length_scale=1, nu=1.5) + RBF(length_scale=1.0) + WhiteKernel(noise_level=1e-1,noise_level_bounds=(1e-30,15))
...
for N_samples in [50,100,250,500,1000,1500,2000]:
    ...
    comments = ["\n"+Model+"\n"
                ...
                "\n n_restarts_optimizer:" +str(n_restarts_optimizer)+
    ...
    regressor = GaussianProcessRegressor(optimizer = optimizer,
                                         kernel = kernel,
